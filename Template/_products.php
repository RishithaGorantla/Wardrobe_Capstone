        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    <div class="col">
                        <button type="submit" style = "background-color:#C28D7E;color:white;" class="btn form-control">Add to Wishlist</button>
                    </div>
                    <div class="col">
                        <form method="post">
                            ...
                            if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                                ...
                                echo '<button type="submit" name="top_sale_submit" style = "background-color:#C28D7E;color:white; font-style: strong;" class="btn form-control font-size-16">Add to Cart</button>';
                            }
                            ?>
                    </div>
                </div>
            ...
            <div class="col-sm-6 py-5">
                ...
                <div id="policy">
                    <div class="d-flex">
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">10 Days <br> Free Returns</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-truck  border p-3 rounded-pill"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">Canada Post <br>Delivered</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-check-double border p-3 rounded-pill"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">100% <br>Cotton</a>
                        </div>
                    </div>
                </div>
                <!--    !policy -->
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">Wardrobe </a>(4.5 out of 5 | 18,198 ratings)</small>
                ...
                <div class="size my-3">
                    ...
                    <div class="d-flex justify-content-between w-75">
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">XS</button>
                        </div>
                        <div class="font-rubik border p-2">
